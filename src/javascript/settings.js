Ext.define('Rally.technicalservices.TwoDGridSettings',{
    ...
    getFields: function(config){
        ...
        var settings = [{
            ...
            labelAlign: 'right',
            blackListFields: [],
            whiteListFields: ['Release','Iteration','ScheduleState','State', 'PreliminaryEstimate'],
            ...
            labelWidth: width,
            blackListFields: [],
            whiteListFields: ['PreliminaryEstimate','Release','Iteration','Project','ScheduleState','State','Owner','SubmittedBy','Tags','Parent','PortfolioItem','Milestones'],
            allowedTypes: ['STRING','RATING'],
            constrained: true,
            bubbleEvents: ['change'],
